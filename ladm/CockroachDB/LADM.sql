...
CREATE SCHEMA IF NOT EXISTS "LADM" AUTHORIZATION root;
--ALTER ROLE root IN DATABASE system SET search_path TO "LADM", public;
...
----	source 					"CI_ResponsibleParty",			-- Omitted for simplicity
                          ...
                          PRIMARY KEY(id, beginLifeSpanVersion),
                          CONSTRAINT share_chk CHECK (numerator > 0 AND denominator > 0 AND numerator <= denominator),
...
--                          --      addressId			  Oid,
--                                addressLocalId			VARCHAR,
--                                addressNamespace  			VARCHAR,
...
CREATE TABLE "LA_SpatialUnitGroup" (
                                       ...
                                       hierarchyLevel		INT8 NOT NULL DEFAULT 0,
                                       label				VARCHAR,
                                       name				VARCHAR,
...
--                            productionMethod			"LI_Lineage",
                            productionMethodStatement	VARCHAR,
--	scope		MD_Scope,
--	additionalDocumentation	CI_Citation
--                            transAndResult			"LA_Transformation",
--                                       transformation		"CC_OperationMethod",
--                                        formulaReference	"CC_Formula",
    			     transformationFormula				VARCHAR,
--			        formulaCitation		   CI_Citation,
    		             transformationStatement				VARCHAR,
--	                        scope		MD_Scope,
--	                        additionalDocumentation	CI_Citation
                             transformationSourceDimensions			SMALLINT,
                             transformationTargetDimensions			SMALLINT,
                             transformedLocation		geometry(POINT),
...
--                                           sugID					"Oid" NOT NULL,	-- PRIMARY KEY containing column of type 'user_defined_type' not yet supported in YugabyteDB
                                           localId					VARCHAR,
                                           namespace  				VARCHAR,
                                           hierarchyLevel				INT8 NOT NULL DEFAULT 1,
                                           label					VARCHAR,
                                           name					VARCHAR,
--	element					"Oid",
                                           beginLifeSpanVersion 			TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
